...
Copying the entire text you can specify your public SSH key while configuring your [Profile](weblets_profile_manager.md) before [deploying a VM](weblets_vm.md).
